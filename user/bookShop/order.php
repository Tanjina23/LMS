...
//getting cart quantity from cart
...
//inserting data to order tables
$insert_order = "INSERT into user_orders(user_id,amount_due,invoice_number,total_products,order_date,
                 order_status) VALUES($user_id,$subtotal,$invoice_number,$count_products,NOW(),
                 '$status')";
...
$insert_pending_orders = "INSERT into orders_pending(user_id,invoice_number,product_id,quantity,
                          order_status)VALUES($user_id,$invoice_number,$product_id,$quantity,
                          '$status')";

  $result_pending_orders = mysqli_query($connect,$insert_pending_orders);
