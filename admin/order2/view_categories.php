...
?>  
        ...
        <td><a href='edit_category.php?edit_category=<?php echo $category_id ?>' class='text-warning'>Edit</a></td>
    <td><a href='delete_category.php?delete_category=<?php echo $category_id ?>' class='text-warning'>Delete</a></td>
</tr>
<?php
    }
