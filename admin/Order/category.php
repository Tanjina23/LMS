...
<br>
<main>
    <h2 class="py-2"style="text-align: center;">Category</h2>
<div class="container">
  <a style="text-decoration: none; font-size:25px;"href="manage_category.php">Add Category</a><br><br>
<table class="table table-striped table-hover table-responsive">
<thead class="table-info">
    <tr>
      <th width="10%"scope="col">S.No #</th>
      <th width="45%"scope="col">Category</th>
      <th width="15%"scope="col">Order Number</th>
  ...
  //  for deletion
    if(isset($_GET['type']) && $_GET['type']!== '' && isset($_GET['id']) && $_GET['id'] > 0){
        ...
        if($type == 'active' || $type == 'deactive'){
          ...
          mysqli_query($connect,"update category set status = '$status' where id ='$id'");
         //  redirect('category.php');
        }
    ...
    <tr>
      ...
      <a href="?id=<?php echo $row['id']?>&type=deactive"><label class="badge bg-success btn ">
        ...
        <a href="manage_category.php?id=<?php echo $row['id']?>"><label class="badge bg-info text-dark">Edit</label></a>&nbsp&nbsp
      </td>
    </tr>
   <?php 
   }
