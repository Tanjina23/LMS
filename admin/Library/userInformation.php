...
if(isset($_POST['submit']))
{
  ...
  $q = mysqli_query($connect,"SELECT id,name,email,address,mobile from user where name like
  '%$_POST[search]%'");
...
$res = mysqli_query($connect,"SELECT id,name,email,address,mobile from user");
