...
<div class="log_img bg-img">
    <br><br><br>
    <div class="box1"><br>
        <h1 style="text-align:center; font-size:30px;">User Login</h1><br><br>
        <div class="login">
        ...
        <p style="color:white;">
        <br><br>
             <a style="color:white;"href=""> Forget password?</a>&nbsp&nbsp&nbsp&nbsp
             New to this website? <a style="color:white;"href="">Register here</a>
             </p>
    </div>
